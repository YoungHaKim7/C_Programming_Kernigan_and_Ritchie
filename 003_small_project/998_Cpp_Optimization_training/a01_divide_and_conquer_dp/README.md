...
```bash
/opt/homebrew/opt/gcc@15/bin/g++-15 -std=c++26 -pedantic -pthread -pedantic-errors -lm -Wall -Wextra -ggdb ./src/main.cpp
mv a.out target
target/./a.out
Test 1 (m=2, n=5): 5
Test 2 (m=1, n=3): 4
...
# justfile(최종+ clangd LSP setting(c++26) 추가251004)
...
cr:
	...
	ninja
	mv build.ninja CMakeCache.txt CMakeFiles cmake_install.cmake target .ninja_deps .ninja_log a.out.dSYM build
	./build/{{target}}
